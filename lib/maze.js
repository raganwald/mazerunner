...
var _sequences = require('./sequences.js');
...
var Maze = function () {
  function Maze() {
    ...
    this.grid = [].concat(_toConsumableArray((0, _sequences.range)(0, size - 1))).map(function (row) {
      return [].concat(_toConsumableArray((0, _sequences.range)(0, size - 1))).map(function (col) {
  ...
  _createClass(Maze, [{
    ...
    value: function print() {
      console.log('*' + [].concat(_toConsumableArray((0, _sequences.range)(1, this.grid.length))).map(function () {
        return '-*';
      }).join(''));
    ...
    value: function zipWithPairs(fn, row) {
      ...
      return [].concat(_toConsumableArray((0, _sequences.zipWith)(fn, firsts, lasts))); // force lazy iteration
    }
  }, {
